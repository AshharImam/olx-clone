  ...
  return (
    <div className="header">
      ...
      <div className="header__searchArea">
        <input
          type="text"
          className="header__searchAreaInput"
          placeholder="Search city, area or location"
        />
      </div>
      <div className="header__searchItems">
        <input
          type="text"
          className="header__searchItemsInput"
          placeholder="Find Cars, Mobile Phones and more..."
        />
      </div>
      <div className="header__actionButoons">
        <button className="header__actionButtons--login">
          <span>Login</span>
        </button>
        <div className="header__actionButtons--sell">
          <a className="_21nYN" rel="" data-aut-id="btnSell">
            <svg
              width="104"
              height="48"
